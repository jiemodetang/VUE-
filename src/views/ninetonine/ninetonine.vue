...
<script>
import allinfoitem from 'components/layout/allinfoitem'
...
export default {
    ...
    watch:{
        ninetonine(){
            this.Bscroll = new BScroll("#nineto-scroll",{
                    probeType:1,
                    click:true,
                    pullUpLoad: {
                    threshold: 50
